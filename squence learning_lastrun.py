...
expName = 'squence learning'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Hirva Agarwal\\Desktop\\Lab in Psych\\squence learning\\squence learning_lastrun.py',
...
trials = data.TrialHandler(nReps=24.0, method='sequential', 
    ...
    trialList=data.importConditions('conditions2.0.csv'),
